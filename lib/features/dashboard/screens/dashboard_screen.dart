...
import '../bloc/statistics_provider.dart';
import '../bloc/achievement_provider.dart';
import '../../learning/bloc/learning_provider.dart';
import '../../../shared/widgets/collaborative_app_bar.dart';
...
class _DashboardScreenState extends State<DashboardScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildQuickStats() {
    return Consumer2<StatisticsProvider, AchievementProvider>(
      builder: (context, statistics, achievements, _) {
            ...
            Card(
              child: Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildQuickStatItem('Level', '${statistics.level}', Icons.star),
                    _buildQuickStatItem('Streak', '${statistics.streak} days', Icons.local_fire_department),
                    _buildQuickStatItem('Achievements', '$unlockedCount/$totalCount', Icons.emoji_events),
                  ],
                ),
              ),
            ),
            ...
            SizedBox(
              ...
              child: LineChart(
                LineChartData(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      spots: statistics.weeklyProgress.asMap().entries.map((e) {
